...
// La classe Tour est une sous classe de la classe Piece
class Tour extends Piece  {

    public Tour() {
        super();
    }
    // pour cree une Tour nous avons besoin de la couleur et de la position. On recuperera c'est attribut dans la classe mère Piece
    public Tour(char couleur, Position position) {
        super(couleur, position);
    }

    // retoune le type de la piece : " Tour "
    @Override
    public String getType() {
        return "tour";
    }

    // methode que vas retourner une ArrayListe de Position de tout les deplacement posible pour pour la tour choisie
    @Override
